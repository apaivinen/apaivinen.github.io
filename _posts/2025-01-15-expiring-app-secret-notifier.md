...
-Anssi
## Sources
- [Get application - Microsoft Graph v1.0 | Microsoft Learn](/assets/img/2025-01-15-expiring-app-secret-notifier/https://learn.microsoft.com/en-us/graph/api/application-get?view=graph-rest-1.0&tabs=http)
